...
<head>
    ...
    <!-- Primary Meta Tags -->
    <title>Management Bengkel Kencana Motor</title>
...
<body>
    ...
    <!-- Slider -->
    <script src="{{ asset('assets/nouislider/dist/nouislider.min.js') }}"></script>
    ...
    <script src="{{ asset('vanillajs-datepicker/dist/js/datepicker.min.js') }}"></script>
